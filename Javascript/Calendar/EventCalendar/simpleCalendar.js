...
var selectedFullDate = {
    ...
    toString: function () {
        return this.year+'年'+this.months[this.month]+this.date+'日('+this.days[this.day]+')';
    },
...
var mainContainerHtml = '<div class="container-fluid simpleCalendarContainer"><div class="row"><div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"><div class="panel panel-primary"><div class="row simpleCalendarHeader"><div><span class="glyphicon glyphicon-circle-arrow-left"></span></div><div><span class="calendarMonthYear"></span><span id="monthYearPicker" class="glyphicon glyphicon-triangle-bottom"></span><div class="customPopover"><div><div> Year & Month </div><div> Date: <input type="text" placeholder="YEAR"></div></div></div></div><div><span class="glyphicon glyphicon-circle-arrow-right"></span></div></div><table class="table simpleCalendarTable"><thead><td>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td>六</td></thead><tbody></tbody><div class="simpleCalendarDatePicker"><div class="row"><button class="datePickerLeftBtn btn btn-default col-lg-2 col-md-2 col-sm-2 col-xs-2 col-xss-2">&lt;</button><span class="datePickerYearRange btn btn-default col-lg-8 col-md-8 col-sm-8 col-xs-8 col-xss-10">2005-2020</span><button class="datePickerRightBtn btn btn-default col-lg-2 col-md-2 col-sm-2 col-xs-2 col-xss-2">&gt;</button></div><div class="row datePickerYearsButton"></div></div></table></div></div><div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><div class="panel panel-primary"><div class="panel-heading"><span>Events</span></div><div class="panel-body"></div></div></div></div></div>';
